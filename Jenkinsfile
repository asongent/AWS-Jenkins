...
#Open your prefered browser and enter your Public DNS 
 http://<your_server_public_DNS>:8080 

#An "Unlock jenkins" screen will pop up asking you to put an Administrative password. To get the password, 
